	...
	*/
	protected function parse_report_texts() :void
	{
		$this->template->assign_vars(array( 
			...
			'FOOTER_TXT' => 'If you use this script, please consider making a donation<br/>ronin:xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx<br/>Even a few SLP would mean the world to me! Thanks!',
		));
	}
